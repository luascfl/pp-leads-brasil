...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "leads-brasil-pp-cli",
		Short: "Manage leads-brasil resources via the leads-brasil API",
		Long: `Manage leads-brasil resources via the leads-brasil API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'leads-brasil-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("leads-brasil-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'leads-brasil-pp-cli profile list')")
