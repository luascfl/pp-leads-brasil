...
but do not stop the import.`,
  ...
  leads-brasil-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  leads-brasil-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | leads-brasil-pp-cli import <resource> --input -`,
